...
In Physiscs Lab, we will use *Logger Pro* for video processing and data analysis. So please make sure you have the required software. Follow the instructions below.
...
| N/A                                                      | [Mac OS X 10.7](https://www.vernier.com/d/dpen3)                |
...
```{caution}
Please note the UI might be different from various Operation System.
```
